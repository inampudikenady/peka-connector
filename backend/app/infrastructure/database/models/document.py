...
class DocumentModel(Base):
    ...
    knowledge_status: Mapped[str] = mapped_column(String(32), default="PENDING", index=True)
    indexed_content_hash: Mapped[str | None] = mapped_column(String(64), default=None)
    indexed_chunk_count: Mapped[int] = mapped_column(default=0)
    knowledge_indexed_at: Mapped[datetime | None] = mapped_column(UTCDateTime(), default=None)
    knowledge_error: Mapped[str | None] = mapped_column(String(500), default=None)
