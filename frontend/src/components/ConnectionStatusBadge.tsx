...
const descriptions: Record<string, string> = {
  connected: 'The connector is communicating successfully with PEKA SaaS. This does not mean source data has been uploaded or synchronized.',
  ...
  reconnecting: 'The connector is retrying after a temporary PEKA SaaS communication failure.',
  disconnected: 'No successful heartbeat has occurred for at least three expected intervals.',
  authentication_failed: 'PEKA SaaS rejected the connector heartbeat credentials.',
  unregistered: 'This appliance has no PEKA SaaS connector credentials.',
  registering: 'A PEKA SaaS registration request is in progress.',
  awaiting_first_heartbeat: 'Registration succeeded and the connector is waiting for its first accepted heartbeat.',
  retired: 'The connector was retired in PEKA SaaS.',
